...
@SlingServletPaths(value="/bin/Demo/dinesh/v112")
public class RecentArticlesServlet2 extends SlingAllMethodsServlet{
@Override
protected void doGet(SlingHttpServletRequest request, SlingHttpServletResponse response)
		throws ServletException, IOException {
	
	ResourceResolver resolver = request.getResourceResolver();
	PageManager pageManager = resolver.adaptTo(PageManager.class);//it will convert ResourceResolver object into PageManager
	Page articlpage = pageManager.getPage("/content/Demo/us/en/articles");
