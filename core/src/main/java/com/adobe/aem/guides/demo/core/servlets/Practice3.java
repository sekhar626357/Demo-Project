...
@SlingServletPaths(value = {"/bin/hello/hi"})
public class Practice3 extends SlingAllMethodsServlet{
	@Override
	...
	protected void doPost(SlingHttpServletRequest request, SlingHttpServletResponse response)
		...
		resolver.commit();
		resolver.close();
		response.getWriter().write("New-User-Created:"+userId);
	...
	protected void doPut(SlingHttpServletRequest request, SlingHttpServletResponse response)
		...
		if(userResource!=null) {
			...
			resolver.commit();
			resolver.close();
			response.getWriter().write("Successfully_UPDATED"+userId);
		}
	...
	protected void doDelete(SlingHttpServletRequest request, SlingHttpServletResponse response)
		...
		resolver.commit();
		resolver.close();
		response.getWriter().write("Successfully_DELETED"+userId);
	}
}
